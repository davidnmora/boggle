...
namespace BoggleGUI {
    ...
    const string BOARD_COLOR    = "#5ACCDC";
    const string DIE_COLOR      = "#E6E6E6";
    const string LETTER_COLOR   = "#F36152";
    const string DIE_COLOR_H    = "#F36152";   // _H = highlighted colors
    const string LETTER_COLOR_H = "#FFFFFF";
    const string WORD_COLOR     = "#000000";
    const string LABEL_COLOR    = "#000000";
